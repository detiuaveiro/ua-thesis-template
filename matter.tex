...
% Input fields.tex commands
\input{fields.tex}

% Configure Hyperlink color
% As a matter or style, you may use this to enable/disable color boxes on links
%\usepackage[breaklinks=true,colorlinks=false,linkcolor=blue]{hyperref}
% Using default style options values provided by the hyperref package 
% with dynamicaly configured pdf metadata
\usepackage[pdfauthor={{\gAuthorFirst} {\gAuthorLast}},
            pdftitle={\gTitle},
            pdfkeywords={\gKeywords},
            pdfsubject={Thesis/Dissertation of University of Aveiro}]{hyperref}
