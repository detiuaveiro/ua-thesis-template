...
%%% Before continuing, please edit the thesis
%%% fields from fields.tex file.
...
%% Import the defined thesis variables
\input{fields.tex}
...
\Author{\gAuthorFirst\\\gAuthorLast}
...
\Abstract{Palavras Chave}{\gKeywords}
         {Resumo}{\gAbstract}
