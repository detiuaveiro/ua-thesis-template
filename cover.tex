...
% Temporary file for .pdf metadata
\newwrite\metadata
\immediate\openout\metadata=myfile.tmp
\immediate\write\metadata{{\ciAuthorFirst} {\ciAuthorLast}}
\immediate\write\metadata{{\ciTitlePT}}
\immediate\write\metadata{{\ciAbstractKeywords}}
\immediate\write\metadata{Thesis/Dissertation of University of Aveiro} % Eventually, change to Abstract text {\ciAbstractText}
