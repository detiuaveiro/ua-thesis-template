...
Foi concebido para ser um guia prático para estudantes, apresentando elementos comuns de uma tese, como formatação de texto, citações, figuras, tabelas e listagens de código. O objetivo é fornecer exemplos claros que possam ser facilmente adaptados para o seu próprio trabalho.
\end{introduction}
